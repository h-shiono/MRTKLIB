...
_KEY_ENUM: dict[str, str] = {
    "pos1-posmode": "MODOPT",
    "pos1-frequency": "FRQOPT",
    "pos1-soltype": "TYPOPT",
    "pos1-ionoopt": "IONOPT",
    "pos1-tropopt": "TRPOPT",
    "pos1-sateph": "EPHOPT",
    "pos1-tidecorr": "TIDEOPT",
    "pos1-snrmask_r": "SWTOPT",
    "pos1-snrmask_b": "SWTOPT",
    ...
    "pos2-sigqzs": "SIGOPT2",
    "pos2-siggal": "SIGOPT3",
    "pos2-sigbds2": "SIGOPT4",
    "pos2-sigbds3": "SIGOPT5",
    "out-solformat": "SOLOPT",
    "out-outhead": "SWTOPT",
    "out-outopt": "SWTOPT",
    "out-outvel": "SWTOPT",
    "out-timesys": "TSYOPT",
    "out-timeform": "TFTOPT",
    "out-degform": "DFTOPT",
    "out-outsingle": "SWTOPT",
    "out-height": "HGTOPT",
    "out-geoid": "GEOOPT",
    "out-solstatic": "STAOPT",
    "out-outstat": "STSOPT",
    "ant1-postype": "POSOPT",
    "ant2-postype": "POSOPT",
    "ant2-initrst": "SWTOPT",
...
def main() -> int:
    ...
    parser.add_argument(
        "-o", "--output", type=Path, default=None, help="output .toml file (single input only)"
    )
