...
| `excluded_sats` | string[] | All | Satellites to exclude, as a PRN list (e.g. `["G01", "G02"]`). Prefix a PRN with `+` to force inclusion instead. The legacy space-separated string form (`"G01 G02"`) is also accepted. |
