 ...
 *        precise ephemeris/clock computation, and satellite antenna offset
 *        functions.
 *
 * This file contains the ERP functions extracted from rtkcmn.c, plus all
 * precise ephemeris functions absorbed from preceph.c with zero algorithmic
 * changes (pure cut-and-paste).
 */
 ...
 * (absorbed from preceph.c — pure cut-and-paste)
 *===========================================================================*/
