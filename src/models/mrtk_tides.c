                    ...
                    const double *pos, double *dr)
{
    ...
    trace(NULL,5,"tide_pl : dr=%.3f %.3f %.3f\n",dr[0],dr[1],dr[2]);
}
                       ...
                       double *dr)
{
    ...
    trace(NULL,3,"tide_solid: pos=%.3f %.3f opt=%d\n",pos[0]*R2D,pos[1]*R2D,opt);
    ...
    trace(NULL,5,"tide_solid: dr=%.3f %.3f %.3f\n",dr[0],dr[1],dr[2]);
}
#endif /* !IERS_MODEL */
...
extern void tide_oload(gtime_t tut, const double *odisp, double *denu)
{
    ...
    trace(NULL,5,"tide_oload: denu=%.3f %.3f %.3f\n",denu[0],denu[1],denu[2]);
}
                      ...
                      double *denu)
{
    ...
    trace(NULL,3,"tide_pole: pos=%.3f %.3f\n",pos[0]*R2D,pos[1]*R2D);
    ...
    trace(NULL,5,"tide_pole : denu=%.3f %.3f %.3f\n",denu[0],denu[1],denu[2]);
}
/* tidal displacement ----------------------------------------------------------
