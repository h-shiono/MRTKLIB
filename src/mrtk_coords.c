 ...
 *
 * This file contains all coordinate transformation and positioning geometry
 * functions extracted from rtkcmn.c with zero algorithmic changes (pure
 * cut-and-paste).
 */
...
/* max satellite number — generous upper bound for stack arrays in dops() */
#ifndef MAXSAT
#define MAXSAT      256
#endif
